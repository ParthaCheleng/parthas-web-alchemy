    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20">
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center md:items-start">
        ...
        >
          ...
          >
            <a href="https://www.linkedin.com/in/partha-jyoti-cheleng-307040130/" className="hover:text-primary transition-colors">
            ...
            <a href="https://github.com/ParthaCheleng" className="hover:text-primary transition-colors">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
